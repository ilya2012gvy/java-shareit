...
(
    ...
    CONSTRAINT uq_requests_users FOREIGN KEY (requestor_id) REFERENCES users (id) ON DELETE CASCADE
);
...
(
    ...
    CONSTRAINT uq_items_requests FOREIGN KEY (request_id) REFERENCES requests (id) ON DELETE CASCADE
);
